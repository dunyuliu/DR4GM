...
class SORDPlotConverter:
    ...
    def __init__(self, input_dir: str, output_dir: str):
        ...
        self.periods = np.array([3.0, 1.0, 0.333])  # seconds

        # SA values for three periods (g) - from plot scripts SA1, SA2, SA3
        self.periods_sa = {
            3.0: np.array([0.126, 0.125, 0.102, 0.095, 0.071, 0.043, 0.032, 0.026]),   # SA1 -> T=3.0s
        ...
        self.periods_std = {
            3.0: np.array([[2.616e-01, 2.971e-01, 3.792e-01, 4.426e-01, 4.946e-01, 5.269e-01, 6.431e-01, 6.595e-01],
